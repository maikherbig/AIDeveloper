...
#    self.comboBox_paddingMode.setItemText(9, _translate("MainWindow", "wrap", None))
    ...
    self.comboBox_paddingMode.setItemText(0, _translate("MainWindow", "cv2.BORDER_CONSTANT", None))
    self.comboBox_paddingMode.setItemText(1, _translate("MainWindow", "cv2.BORDER_REFLECT", None))
    self.comboBox_paddingMode.setItemText(2, _translate("MainWindow", "cv2.BORDER_REFLECT_101", None))
    self.comboBox_paddingMode.setItemText(3, _translate("MainWindow", "cv2.BORDER_DEFAULT", None))
    self.comboBox_paddingMode.setItemText(4, _translate("MainWindow", "cv2.BORDER_REPLICATE", None))
    self.comboBox_paddingMode.setItemText(5, _translate("MainWindow", "cv2.BORDER_WRAP", None))
...
#        self.comboBox_paddingMode_pop.setItemText(9, _translate("Form", "wrap", None))
        ...
        self.comboBox_paddingMode_pop.setItemText(0, _translate("Form", "cv2.BORDER_CONSTANT", None))
        self.comboBox_paddingMode_pop.setItemText(1, _translate("Form", "cv2.BORDER_REFLECT", None))
        self.comboBox_paddingMode_pop.setItemText(2, _translate("Form", "cv2.BORDER_REFLECT_101", None))
        self.comboBox_paddingMode_pop.setItemText(3, _translate("Form", "cv2.BORDER_DEFAULT", None))
        self.comboBox_paddingMode_pop.setItemText(4, _translate("Form", "cv2.BORDER_REPLICATE", None))
        self.comboBox_paddingMode_pop.setItemText(5, _translate("Form", "cv2.BORDER_WRAP", None))
